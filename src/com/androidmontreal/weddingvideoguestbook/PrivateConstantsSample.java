...
public class PrivateConstantsSample {
	...
	/* Put a keyword here that you would use to describe your data in your app ie: wedding, garden, food */
	public final static String DATA_KEYWORD = "fielddb";
	...
	public final static String SERVER_TOKEN = "servertoken";
